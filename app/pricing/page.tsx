          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className={plan.button}>
                {index === 0 && (
                  <Link
                    href="https://buy.stripe.com/test_4gwg1t6M31Ji3FS144"
                ...
                {index === 1 && (
                  <Link
                    ...
                    href="https://buy.stripe.com/test_4gw02vdar3RqfoA4gh"
                    className="rounded-3xl my-4  py-2 text-white w-full mx-auto items-center flex justify-center bg-gradient-to-r from-emerald-500 to-blue-300"
                  >
                    Buy Now
                  </Link>
                ...
                {index === 2 && (
                  ...
                  <Link
                    href="/pk_test_51QuhMbIrhmyiQnbKLSALyTfXspgfQ77oc97JkCyoFtTLFJutb0ltnlJnji2KWbxdzwyFwgNJffPuLKtDlqr5KQNP00I3nHXElF"
